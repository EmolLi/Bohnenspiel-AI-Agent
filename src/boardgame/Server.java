...
public class Server implements Runnable {
	...
	//protected static final int DEFAULT_PORT = 8133;
	...
	private void endGame(String reason) {
		...
		case Board.DRAW:
			msg += "DRAW" + "         Player-0 score: " + board.getScore(0) + "  Player-1 score: " + board.getScore(1);
			break;
		case Board.NOBODY:
			msg += "UNDECIDED";
			break;
		...
		case Board.CANCELLED1:
			...
			break;
		default:
			msg += "WINNER " + board.getWinner() + "         Player-0 score: " + board.getScore(0)
					+ "  Player-1 score: " + board.getScore(1);
		}
	...
	class ClientHandler implements Runnable {
		...
		private boolean closed = false; // Shared var: synchronize on this
										// object
			...
			try {
				while (true) {
					...
					if (moveIsSet()) {
						...
						// Move did not come in time. Using a random move
						// instead.
						// Random move is set by the timeOut method of the
						// Server.
						inputLine = getMove();
